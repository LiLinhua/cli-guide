'use strict';
/* 窗口布局纯函数 (可无头测试) */
const PET_W = 150, PET_H = 150, MARGIN = 20, MENU_W = 180;
/* Windows 无边框透明窗有最小尺寸(~32x38), 用更大胶囊尺寸避免缩成黑块 */
const STEALTH_SIZE = process.platform === 'win32' ? 36 : 12;
const STEALTH_BAR_LONG = process.platform === 'win32' ? 72 : 30;
